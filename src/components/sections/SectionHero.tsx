...
export const SectionHero: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section className="relative w-screen flex items-center justify-center overflow-hidden h-[300px]"
      style={{
      ...
      <div className="relative z-20 text-center text-white px-4 max-w-4xl">
        ...
        {/* Optional Subtitle */}
        {subtitle && <p className="text-lg md:text-xl mb-6 text-white/90">{subtitle}</p>}
